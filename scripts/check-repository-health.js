      ...
      // New line indicates the end of a package entry
        ...
        if (pkgName && pkgVersion && pkgFilename) {
          if (aptPackages.has(pkgName)) {
            ...
            // Only make this an error if the oldest deb with for the same package is older than 24 hours. The cron job on the server running aptly runs once every 6 hours, 24 hour is a bit more reaso[...]
